...
def handle_app_image():
    ...
    filterFace = (extractIdName(file_loc))
    mainface = jinja_strlist_to_intlist(filterFace)
    ...
    with sql.connect("FRASD1test.db") as connection:
        ...
        out = [8171003, 8171006, 8171001, 8171002, 8171055, 8171063, 8171033, 8171049]
        print(out)
        print(int_stu)
